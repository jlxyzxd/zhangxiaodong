...
//    msgBox1.setText(txt);
// //   msgBox1.exec();
//        if( txt.left(4)=="写入"|| txt.left(4)=="读取")
//        {
...
//        }
    ...
    if(!m_iWidgets.contains(perIndex))
    {
        ...
        if((nullptr == parentWidget)||((perIndex.column()==4)&&(txt.left(4)!="写入"))||((perIndex.column()==3)&&(txt.left(4)!="读取")))
            return;
        ...
        tempWidget->setStyleSheet("QTreeView::item { border: 0.5px ; border-style: solid ; border-color: lightgray ;} ");;
    }
    else
    {
